...
export const Dashboard = ({ history })  => {
    ...
    const myEventsHandler = async () => {
        try {
            ...
            const response = await api.get('/user/event', { headers: { user } })
            ...
            <div className="filter-panel">
                <Dropdown isOpen={dropdownOpen} toggle={toggle}>
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownItem onClick={() => filterHandler('fukibur')} active={rSelected === 'fukibur'}>Fukibur</DropdownItem>
                        <DropdownItem onClick={() => filterHandler('samurai')} active={rSelected === 'samurai'} >Samurai</DropdownItem>
                        <DropdownItem color="primary" onClick={() => filterHandler('kendo')} active={rSelected === 'kendo'} >Kendo</DropdownItem>
                    </DropdownMenu>
                </Dropdown>
            </div>
